Provision of a filling within a void that is a subtraction from an element. It requires the concept "Voiding" to be supported for that element. There are two roles involved in the concept "Filling":
