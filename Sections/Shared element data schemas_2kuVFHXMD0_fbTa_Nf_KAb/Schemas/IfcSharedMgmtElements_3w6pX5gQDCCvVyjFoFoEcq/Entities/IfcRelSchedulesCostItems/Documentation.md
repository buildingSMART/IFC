An _IfcRelSchedulesCostItems_ is a subtype of _IfcRelAssignsToControl_ that enables one or many instances of _IfcCostItem_ to be assigned to an instance of _IfcCostSchedule_.
